    ...
    request(
        ...
        (err, res, body) => {
            ...
            if (res.statusCode == 200){
                try{
                    console.log('YYY1 typeof(body): ' + typeof(body));
                    console.log('YYY1 body: ' + body);
                    body = JSON.parse(body);
                    console.log('YYY2 typeof(body): ' + typeof(body));
                    console.log('YYY2 body: ' + body);
                    body.result = body.result || {};
                    console.log('YYY3 body.result: ' + body.result);
                    state.next(
